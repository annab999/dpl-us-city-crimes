...
# inputs
parser = argparse.ArgumentParser(description = 'Read semi-raw Parquets, clean and choose columns, combine cities per month.')
...
parser.add_argument('month', help = 'month of data to use')
